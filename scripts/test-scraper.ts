...
async function run(): Promise<void> {
  ...
  const map = {
    ...
    ozbargain_rss: new RssCommunityScraper("ozbargain_rss"),
    redflagdeals_forum_rss: new RssCommunityScraper("redflagdeals_forum_rss"),
    nairaland_rss: new RssCommunityScraper("nairaland_rss"),
    wilddog_za_rss: new RssCommunityScraper("wilddog_za_rss"),
    carbonite_za_rss: new RssCommunityScraper("carbonite_za_rss"),
    pantip_forum_rss: new RssCommunityScraper("pantip_forum_rss"),
    voz_forum_rss: new RssCommunityScraper("voz_forum_rss"),
    tinhte_rss: new RssCommunityScraper("tinhte_rss"),
    adrenaline_forum_rss: new RssCommunityScraper("adrenaline_forum_rss"),
    teambhp_forum_rss: new RssCommunityScraper("teambhp_forum_rss"),
    skyscrapercity_mx_rss: new RssCommunityScraper("skyscrapercity_mx_rss"),
    skyscrapercity_ar_rss: new RssCommunityScraper("skyscrapercity_ar_rss"),
    kaskus_rss: new RssCommunityScraper("kaskus_rss"),
