        ...
        regionalIds.length > 0
          ? postgres.query<TopicRow>(
              ...
              select
                ...
                total_views,total_likes,total_comments,source_ids,raw_post_ids,burst_z,lifecycle_stage,source_diversity,dominant_source_share,representative_excerpts,rank,period_start,period_end,
